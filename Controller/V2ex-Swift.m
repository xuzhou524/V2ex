...
@interface V2ex_Swift()<GADInterstitialDelegate>{
...
-(void)CheakAd{//这一部分的逻辑大家根据自身需求定制
    //谷歌插屏广告
    self.interstitial = [[GADInterstitial alloc] initWithAdUnitID:@"ca-app-pub-9353975206269682/1164640455"];
